...
function(a, b) {
    ...
    function o(a, b, c) {
        ...
        a.replace("{name}", c || "").replace("{friendlyName}", g).replace("{img}", f + (k < 2 ? h.toUpperCase() : h) + "." + d).replace("{uni}", b).replace("{alt}", e.convert(b))
    }
    function p(a, b, c) {
    ...
    function E() {
        ...
        if (!b.sprite && b.lasyEmoji[0] && b.lasyEmoji.eq(0).is(".lazy-emoji")) {
            ...
            b.lasyEmoji.each(function() {
                var b = a(this)
                  , e = b.offset().top;
                if (e > c && e < d && b.attr("src", b.data("src")).removeClass("lazy-emoji"),
                e > d)
                    return !1
            }),
    ...
    function L(b, c, d) {
        ...
        b.on("@filter.click", function(a) {
            ...
            null === b.searchSel && (b.searchSel = x(c[0]))) : (O.is(".focused") || c.trigger("focus"),
            d.preventDefault()),
            !1
        }).on("@change", function() {
            ...
            m(b, "change", [b.editor]),
            c.trigger("blur").trigger("change")) : c.trigger("blur"),
